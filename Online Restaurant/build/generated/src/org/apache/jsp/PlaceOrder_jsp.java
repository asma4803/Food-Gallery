    ...
    try {
      ...
      out.write("        ");
            ...
            try {
                        ...
                        for( CartDTO d: list)
                        {
                            query="Inser into selectedItems (itemName,itemPrice,itemQuan) values('"+d.getName()+"','"+d.getPrice()+"','"+d.getQuantity()+"')";
                            stmt4=con.createStatement();
                            rs=stmt4.executeUpdate(query);
                        }
            }
            catch(Exception exe)
            {
            ...
            finally
            {
                ...
                {
      out.write("\n");
      out.write("                    <script>windows.alert(\"Thanks for Ordering\").</script>\n");
      out.write("                ");
}
            }
